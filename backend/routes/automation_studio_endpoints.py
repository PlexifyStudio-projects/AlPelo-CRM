...
TRIGGER_DEFINITIONS = [
    {
        "type": "hours_before_appt",
        "name": "Antes de una cita",
        "description": "Se envía X horas antes de una cita confirmada",
        "category": "appointments",
        "config_fields": [
            {"key": "hours", "label": "Horas antes", "type": "number", "default": 24, "min": 1, "max": 168},
        ],
        "variables": ["nombre", "negocio", "hora", "fecha", "profesional", "servicio"],
    },
    {
        "type": "hours_after_complete",
        "name": "Después de una visita",
        "description": "Se envía X horas después de completar una cita",
        "category": "appointments",
        "config_fields": [
            {"key": "hours", "label": "Horas después", "type": "number", "default": 2, "min": 1, "max": 72},
        ],
    ...
    },
    {
        ...
        "name": "Cita creada",
        "description": "Se envía al crear o confirmar una nueva cita",
        "category": "appointments",
        "config_fields": [],
        "variables": ["nombre", "negocio", "hora", "fecha", "profesional", "servicio"],
    },
    {
        ...
        "category": "appointments",
        "config_fields": [],
        "variables": ["nombre", "negocio", "hora", "fecha", "profesional"],
    },
    {
        "type": "no_show",
        "name": "No-show",
        "description": "Se envía al día siguiente de una inasistencia",
        "category": "appointments",
        "config_fields": [],
    ...
    },
    {
        ...
        "name": "Sin visitar en X días",
        "description": "Se envía cuando un cliente no visita en cierto tiempo",
        "category": "clients",
        "config_fields": [
            {"key": "days", "label": "Días sin visitar", "type": "number", "default": 30, "min": 7, "max": 365},
        ],
    ...
    },
    {
        "type": "new_client",
        "name": "Cliente nuevo",
        "description": "Se envía al registrar un nuevo cliente",
        "category": "clients",
        "config_fields": [],
        "variables": ["nombre", "negocio"],
    },
    ...
    },
    {
        ...
        "name": "Alcanza X visitas",
        "description": "Se envía cuando un cliente alcanza cierta cantidad de visitas",
        "category": "clients",
        "config_fields": [
            {"key": "milestone", "label": "Número de visitas", "type": "number", "default": 10, "min": 3, "max": 100},
        ],
        "variables": ["nombre", "negocio"],
    },
    {
        "type": "client_anniversary",
        "name": "Aniversario como cliente",
        "description": "Se envía al cumplir 1 año desde la primera visita",
        "category": "clients",
        "config_fields": [],
        "variables": ["nombre", "negocio"],
    },
    {
        ...
        "name": "Pago recibido",
        "description": "Se envía al registrar un pago por un servicio",
        "category": "payments",
        "config_fields": [],
    ...
    },
    {
        ...
        "name": "Pago pendiente",
        "description": "Se envía 24h después de un servicio sin pago registrado",
        "category": "payments",
        "config_fields": [],
        "variables": ["nombre", "negocio"],
    },
