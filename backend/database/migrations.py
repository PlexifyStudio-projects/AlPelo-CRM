def run_migrations(engine):
    ...
    migrations = [
        ...
        # DIAN / Fiscal config
        ("tenant", "nit", "VARCHAR(20)"),
        ("tenant", "legal_name", "VARCHAR(300)"),
        ("tenant", "person_type", "VARCHAR(20)"),
        ("tenant", "tax_regime", "VARCHAR(30)"),
        ("tenant", "ciiu_code", "VARCHAR(10)"),
        ("tenant", "fiscal_address", "TEXT"),
        ("tenant", "municipality_code", "VARCHAR(10)"),
        ("tenant", "department_code", "VARCHAR(5)"),
        ("tenant", "fiscal_phone", "VARCHAR(30)"),
        ("tenant", "fiscal_email", "VARCHAR(200)"),
        ("tenant", "dian_resolution_number", "VARCHAR(50)"),
        ("tenant", "dian_resolution_date", "DATE"),
        ("tenant", "invoice_prefix", "VARCHAR(10)"),
        ("tenant", "invoice_range_from", "INTEGER"),
        ("tenant", "invoice_range_to", "INTEGER"),
        ("tenant", "resolution_valid_from", "DATE"),
        ("tenant", "resolution_valid_to", "DATE"),
