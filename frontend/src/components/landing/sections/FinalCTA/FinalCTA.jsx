...
export default function FinalCTA() {
  return (
    <section className="final-cta" id="final-cta" aria-label="Llamada a la acción final" style={{ position: 'relative' }}>
      ...
      <div className="final-cta__container" style={{ position: 'relative', zIndex: 1 }}>
        <h2 className="final-cta__title">Empieza a transformar tu negocio hoy</h2>
        <p className="final-cta__subtitle">
          Gestiona clientes, automatiza WhatsApp y haz crecer tu negocio con PlexifyStudio CRM.
        </p>
