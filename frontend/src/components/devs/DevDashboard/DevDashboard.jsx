...
const DevDashboard = () => {
  ...
  const fetchStats = useCallback(async () => {
    try {
      ...
      // Use mock data while endpoint doesn't exist
      setStats({
        total_tenants: 1,
        active_tenants: 1,
    ...
    <div className={b}>
      ...
      <div className={`${b}__kpis`}>
        <div className={`${b}__kpi`}>
          <div className={`${b}__kpi-icon ${b}__kpi-icon--primary`}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="4" y="2" width="16" height="20" rx="2" /><path d="M9 22v-4h6v4" /><path d="M8 6h.01M16 6h.01M8 10h.01M16 10h.01" /></svg>
          </div>
        ...
        <div className={`${b}__kpi`}>
          <div className={`${b}__kpi-icon ${b}__kpi-icon--success`}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22z" /></svg>
          </div>
          <div className={`${b}__kpi-info`}>
      ...
      <div className={`${b}__section`}>
        <div className={`${b}__section-header`}>
          ...
          <span className={`${b}__section-badge`}>{stats.tenants?.length || 0}</span>
        </div>
