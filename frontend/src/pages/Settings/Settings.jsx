...
function WompiPanel({ addNotification }) {
  ...
  return (
    <div style={{ padding: '24px 32px' }}>
      ...
      <p style={{ fontSize: 13, color: 'rgba(0,0,0,0.45)', marginBottom: 24 }}>Paga a tus profesionales directamente desde Nomina via Nequi, Bancolombia o Daviplata. Powered by Wompi (Bancolombia).</p>
      ...
      <div style={{ padding: 16, background: 'rgba(30,64,175,0.03)', borderRadius: 12, marginBottom: 24, border: '1px solid rgba(30,64,175,0.08)' }}>
        ...
        <ol style={{ fontSize: 12, color: 'rgba(0,0,0,0.5)', paddingLeft: 18, margin: 0, lineHeight: 1.8 }}>
          <li>Registrate en <strong>wompi.co</strong> y activa "Pagos a Terceros" con el RUT del negocio</li>
          <li>Wompi verifica y activa la cuenta (1-3 dias habiles)</li>
          <li>Copia el ID Principal (llave publica) y API Key (llave privada) aqui</li>
          <li>Configura los datos bancarios de cada profesional en Equipo</li>
          <li>Desde Nomina, al pagar → el dinero va directo a su cuenta/Nequi/Daviplata</li>
        </ol>
      </div>
