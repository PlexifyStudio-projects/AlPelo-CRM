            ...
            <div key={p.id} className={`${b}__card ${p.is_low_stock ? `${b}__card--low` : ''}`}>
              <div className={`${b}__card-top`}>
                <div className={`${b}__card-info`}>
                  ...
                  {p.sku && <span className={`${b}__card-sku`}>{p.sku}</span>}
                </div>
                {p.category && <span className={`${b}__card-cat`}>{p.category}</span>}
              </div>

              <div className={`${b}__card-prices`}>
                <div className={`${b}__card-price`}>
                  <span className={`${b}__card-price-label`}>Venta</span>
                  <span className={`${b}__card-price-val`}>{formatCOP(p.price)}</span>
                </div>
                <div className={`${b}__card-price`}>
                  <span className={`${b}__card-price-label`}>Costo</span>
                  <span className={`${b}__card-price-val ${b}__card-price-val--muted`}>{formatCOP(p.cost)}</span>
                </div>
                <div className={`${b}__card-price`}>
                  <span className={`${b}__card-price-label`}>Margen</span>
                  <span className={`${b}__card-price-val ${p.margin_pct > 40 ? `${b}__card-price-val--high` : p.margin_pct > 20 ? `${b}__card-price-val--mid` : `${b}__card-price-val--low`}`}>{p.margin_pct}%</span>
                </div>
              </div>

              <div className={`${b}__card-stock`}>
                <div className={`${b}__card-stock-info`}>
                  <span className={`${b}__card-stock-label`}>Stock</span>
                  <span className={`${b}__card-stock-val ${p.is_low_stock ? `${b}__card-stock-val--low` : ''}`}>{p.stock}</span>
                  {p.is_low_stock && <span className={`${b}__card-stock-alert`}>Min: {p.min_stock}</span>}
                </div>
